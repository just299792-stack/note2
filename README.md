...
| 工具 | 文字输入（样式条：字号/加粗/斜体/下划线/对齐/颜色/高亮/预设）、形状、12+ 颜色、粗细可调、插入图片/拍照、PDF 导入标注（可选页范围）、笔记附件（任意文件） |
...
| 转移 | 导出 `.note` / PDF（带页眉页码）/ 资料库 `.notebook` / 笔记文字 `.txt`，导入笔记文件；支持 iPadOS「分享」发送到「文件」/隔空投送 |
