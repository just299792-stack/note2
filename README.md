...
| 录音 | 每篇笔记录音/回放/删除（需 https 环境），波形预览、点击波形定位，回放时笔迹与音频同步重现、跨页自动翻页跟随 |
| 纸张 | 空白 / 横线 / 方格 / 点阵 / 康奈尔 / 清单 / 计划表 / 故事板 / 乐谱 / 法律纸 × 6 色；模板中心可把任意页存为自定义模板，新建笔记一键选用 |
| 组织 | 科目 → 笔记本 → 笔记，页面缩略图侧栏，多页管理（增/删/复制）；跨笔记本全局搜索（标题+文字） |
