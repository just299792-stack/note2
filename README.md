...
| 类别 | 功能 |
| --- | --- |
| 书写 | Apple Pencil 压力感应钢笔、荧光笔（乘色混合）、橡皮擦（整笔擦除）、套索选择（移动/删除/复制）；手绘形状按住 250ms 或松手即自动识别；笔型可切换钢笔/铅笔/画笔/虚线/点线，常用工具可收藏一键切换 |
...
| AI | 内置 AI 助手（DeepSeek 模型，经电脑端服务器代理，密钥不进入前端）；可结合当前笔记提问，流式回答 |
