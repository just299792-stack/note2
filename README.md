...
| 类别 | 功能 |
| --- | --- |
| 书写 | Apple Pencil 压力感应钢笔、荧光笔（乘色混合）、橡皮擦（整笔擦除）、套索选择（移动/删除/复制）；手绘形状按住 250ms 或松手即自动识别并磁吸到网格；笔型可切换钢笔/铅笔/画笔/虚线/点线，常用工具可收藏一键切换 |
| 工具 | 文字输入（样式条：字号/加粗/斜体/下划线/对齐/颜色/高亮/预设，字体可换系统/圆体/衬线/等宽）、形状、12+ 颜色、粗细可调、插入图片/拍照、PDF 导入标注（可选页范围）、笔记附件（任意文件） |
...
| 纸张 | 空白 / 横线 / 方格 / 点阵 / 康奈尔 / 清单 / 计划表 / 故事板 / 乐谱 / 法律纸 × 6 色（细腻纸纹），行距可调；模板中心内置常用模板 + 自定义模板，新建笔记可选模板、可插入模板页 |
