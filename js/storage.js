...
export function newLibrary() {
  ...
  return {
    ...
    settings: {
      ...
      textPresets: [], autoBackup: true, tabs: [], defaultPageSize: 'standard', markup: false, aiPrompt: '', trash: []
    },
    subjects: [
...
export function sanitize(raw) {
  ...
  for (const id of Object.keys(lib.notes)) {
    ...
    n.colorTag = typeof n.colorTag === 'string' && ['#ef4444','#f97316','#facc15','#22c55e','#3b82f6','#a855f7'].includes(n.colorTag) ? n.colorTag : null;
  }
  // active 兜底
